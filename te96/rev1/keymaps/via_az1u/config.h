...
// /* AZ1UBALL settings */
#define PIPIMORONIMORONI_TRACKBALL_SCALE 20// default 5

#define TAP_CODE_DELAY 5
#define DYNAMIC_KEYMAP_LAYER_COUNT 4

// トラックボールの基本感度設定
// #define PIPIMORONIMORONI_TRACKBALL_SCALE 20  // 15から20に増加してより敏感に

// マウス移動のスムーズ化設定
#define MOUSEKEY_INTERVAL 8       // より滑らかな動作のため更新間隔を短く
#define MOUSEKEY_DELAY 0         // 初期遅延なし
#define MOUSEKEY_TIME_TO_MAX 60  // 加速までの時間を長めに
#define MOUSEKEY_MAX_SPEED 7     // 最高速度を適度に
#define MOUSEKEY_MOVE_DELTA 5    // 初期移動量を増加

// トラックボールの精度向上のための追加設定
#define POINTING_DEVICE_TASK_THROTTLE_MS 1  // ポーリング間隔を最小に
